...
public class ClosestFromAvatar : MonoBehaviour
{
    ...
    public TargetLogic redirectManager2;
    ...
    void Start()
    {
        ...
        redirectManager2 = GameObject.FindObjectOfType<TargetLogic>();
    }
    ...
    void Update()
    {
        ...
        {
            engageClosest = GameObject.Find("Targets/Left");
        }
        if ((redirectManager.numObject % 2) == 1)
        {
            engageClosest = GameObject.Find("Targets/Right");
        }
