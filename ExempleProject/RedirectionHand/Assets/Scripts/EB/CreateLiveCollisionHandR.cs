...
public class CreateLiveCollisionHandR : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if(this.gameObject.name == "WarpedRightHandColl")
        {
            posApproxSkel[0] = handWarpRight.CustomBones[2].transform.position;
            posApproxSkel[1] = handWarpRight.CustomBones[2].transform.position;
            posApproxSkel[2] = handWarpRight.CustomBones[0].transform.position;
            posApproxSkel[3] = handWarpRight.CustomBones[15].transform.position;
            posApproxSkel[4] = handWarpRight.CustomBones[3].transform.position;
            posApproxSkel[5] = handWarpRight.CustomBones[4].transform.position;
            posApproxSkel[6] = handWarpRight.CustomBones[5].transform.position;
            posApproxSkel[7] = handWarpRight.CustomBones[6].transform.position;
            posApproxSkel[8] = handWarpRight.CustomBones[7].transform.position;
            posApproxSkel[9] = handWarpRight.CustomBones[8].transform.position;
            posApproxSkel[10] = handWarpRight.CustomBones[9].transform.position;
            posApproxSkel[11] = handWarpRight.CustomBones[10].transform.position;
            posApproxSkel[12] = handWarpRight.CustomBones[11].transform.position;
            posApproxSkel[13] = handWarpRight.CustomBones[12].transform.position;
            posApproxSkel[14] = handWarpRight.CustomBones[13].transform.position;
            posApproxSkel[15] = handWarpRight.CustomBones[14].transform.position;
            posApproxSkel[16] = handWarpRight.CustomBones[16].transform.position;
            posApproxSkel[17] = handWarpRight.CustomBones[17].transform.position;
            posApproxSkel[18] = handWarpRight.CustomBones[18].transform.position;
        }
